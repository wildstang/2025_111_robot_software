...
public class BlueLeftJackInTheBot extends AutoProgram {
    ...
    protected void defineSteps() {
        ...
        intake1.addStep(new SuperStructureSmartStep(SuperstructurePosition.CORAL_REEF_L3));
        ...
        intake2.addStep(new SuperStructureSmartStep(SuperstructurePosition.CORAL_REEF_L4));
        ...
        intake3.addStep(new SuperStructureSmartStep(SuperstructurePosition.CORAL_REEF_L4));
