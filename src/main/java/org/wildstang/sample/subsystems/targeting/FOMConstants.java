...
public class FOMConstants{
    ...
    public static final double ROBOT_SPEED = 1.012;
    public static final double ROT_SPEED = 2.073;
    public static final double NUM_TAGS = 8.925;
    public static final double ODOMETRY_DISPLACEMENT = 6.67;
