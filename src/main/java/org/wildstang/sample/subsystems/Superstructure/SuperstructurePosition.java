...
//first value its arm second value lift position.
    ...
    CORAL_REEF_L2(85.2,9.05*9/5.0, "Reef L2"),//80.3, 24.5
    CORAL_REEF_L3(85.9,20.5*9/5.0, "Reef L3"),//80.5, 45.5
    CORAL_REEF_L4 (79.6, 45.5*9/5.0, "Reef L4"),
    ...
    STOWED_AFTER_PICKUP_HIGH(58,25, "Post Pickup High"),
